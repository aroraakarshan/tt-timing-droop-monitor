...
while changing peak concurrent switching. A separate
16-bit source register drives a selectable three-to-six-round combinational
...
| `ui_in[6:5]` | Select canary depth from three through six rounds |
